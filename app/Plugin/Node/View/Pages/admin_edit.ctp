...
<?php echo $this->Form->create('Node'); ?>
 ...
 <div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title"><?php echo __('Edit Page'); ?></h3>
  </div>
...
<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Node.id')), array('class' => 'btn btn-danger'), __('Are you sure you want to delete # %s?', $this->Form->value('Node.id'))); ?></li>
	</ul>
...
<div id="accordion" class="panel-group">
	...
	?>
                              ...
                              <div class="form-group">
                            <?php	
                                echo $this->Form->input('user_id', array( 'label' => __('Authored by'), 'class' => 'form-control' )  );	
                            ?>
                            </div>
