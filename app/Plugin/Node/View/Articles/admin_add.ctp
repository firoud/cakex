...
<?php echo $this->Form->create('Node'); ?>
 ...
 <div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title"><?php echo __('Create Article'); ?></h3>
  </div>
  ...
  <?php echo $this->Form->input('tags', array('type' => 'text', 'label' => false, 'class' => 'tagsinput form-control', 'id' => 'tags_tagsinput', 'after' =>  '<div class="help-block">' . __('Enter a comma-separated list of words to describe your content.') . '</div>' )); ?>
...
<div id="accordion" class="panel-group">
    ...
    <?php    		
		...
		echo $this->Form->input('promote', array( 'label' => 'Promoted to front page' , 'default' => 1));
